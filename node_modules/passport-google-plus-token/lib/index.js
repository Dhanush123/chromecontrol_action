...
var GooglePlusTokenStrategy = function (_OAuth2Strategy) {
  ...
  function GooglePlusTokenStrategy(_options, _verify) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GooglePlusTokenStrategy).call(this, options, verify));
    ...
    _this._profileURL = options.profileURL || 'https://www.googleapis.com/plus/v1/people/me';
